- find & grep & awk #bash #pattern-matching #UNFINISH
  ...
  CLOCK: [2026-05-18 Mon 03:03:36]--[2026-05-18 Mon 03:03:37] =>  00:00:01
  :END:
...
- linux generate ramdom string #linux #generate-string #UNFINISH
  collapsed:: true
  :LOGBOOK:
...
- bash wait for async~ functions #bash #function #workflow #UNFINISH
  collapsed:: true
...
- bash export #bash #export #pathing #UNFINISH
  collapsed:: true
...
- BASH CHEATSHEET&BASIC #bash #UNFINISH
  ...
  :END:
	...
	-
- bash jq & json object & array #bash #json #data-type #UNFINISH
  collapsed:: true
	- https://www.baeldung.com/linux/jq-command-json
	- https://www.baeldung.com/linux/jq-add-objects-json-array
- bash pipe #bash #pipe #UNFINISH
  collapsed:: true
...
- passing string as file #bash #pipe #write-file #UNFINISH
  collapsed:: true
  :LOGBOOK:
  CLOCK: [2026-05-18 Mon 03:08:22]
  :END:
...
- regular expression #bash #parameter #pattern-matching #UNFINISH
  collapsed:: true
	- https://regex101.com/list-substitution
- bash read user input/prompt #bash #prompt #UNFINISH
  collapsed:: true
  :LOGBOOK:
