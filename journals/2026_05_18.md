...
- linux generate ramdom string #linux #generate-string
  collapsed:: true
  :LOGBOOK:
...
- bash wait for async~ functions #bash #function #workflow
  collapsed:: true
...
- bash export #bash #export #pathing
  collapsed:: true
...
- BASH CHEATSHEET&BASIC #bash
  ...
  :END:
	...
	-
- bash jq & json object & array #bash #json #data-type
  collapsed:: true
...
- passing string as file #bash #pipe #write-file
  collapsed:: true
  :LOGBOOK:
...
- regular expression #bash #parameter #pattern-matching
  collapsed:: true
	- https://regex101.com/list-substitution
- bash read user input/prompt #bash #prompt
  collapsed:: true
  :LOGBOOK:
