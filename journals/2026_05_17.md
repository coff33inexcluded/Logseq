- force case insensitive: #bash #parameter
  collapsed:: true
	- ```bash
	  ...
	  ```
	- {{renderer :linkpreview,https://linuxbash.sh/post/force-case-insensitive-matching-in-varvar-via-shopt--s-nocasematch}}
	-
...
- TODO ls filter files by type & find #bash #linux #ls
	- {{renderer :linkpreview,https://linuxvox.com/blog/list-of-all-folders-and-sub-folders/}}
	  :LOGBOOK:
	  CLOCK: [2026-05-17 Sun 21:02:25]--[2026-05-17 Sun 21:02:26] =>  00:00:01
	  :END:
	- {{renderer :linkpreview,https://www.baeldung.com/linux/ls-files-by-type}}
	- {{renderer :linkpreview,https://unix.stackexchange.com/questions/165455/how-can-i-list-files-by-type-with-ls}}
